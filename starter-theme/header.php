	...
	<header class="header o-section">
		<div class="o-section__wrapper">
			<div class="header__navbar row u-flex--center">
				<a class="header__navbar-logo p-0 col-lg-2 col-md-3 col-4" href="#">
					<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/logo.svg" alt="" class="header__logo" />
				</a>
				<nav class="header__navbar-container p-0 col-lg-10 col-md-9 col-8">
					<div class="header__navbar-hamburger-icon js-header-hamburger">
					...
					<ul class="header__navbar-nav">
						<li class="header__nav--close-icon js-close-icon">
						...
						<li class="header__nav-item">
							<a class="nav-link" href="#">Popular Dishes</a>
						</li>
						<li class="header__nav-item">
