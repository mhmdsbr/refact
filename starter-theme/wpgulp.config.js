...
const projectURL = 'http://localhost/refact';
...
const styleDestination = './assets/styles/style.min.css';
...
const cssVendorDestination = './assets/styles/vendor.min.css';
...
const jsVendorDestination = './assets/scripts/vendor.min.js';
...
const jsCustomDestination = './assets/scripts/main.min.js';
